...
1. Для ручного открытия обработки следует зайти в раздел **Продажи** - **Сервис** - **Дополнительные обработки** - **АРМКассира**
...
Список выводит документы возвратов за выбранный период. Используется для оформления возрата клиенту. 
...
Список выводит документы возврата наличныех (РКО) внесенные на основании Возврата товаров клиентов
...
3. При оплате оплате наличными нажимаем "**Создать документы оплаты и пробить чек**" - "**Пробить**".
...
4. В окне предпросмотра чека при необходимости выбираем вариант отправки электронного чека и нажимаем "Пробить"
